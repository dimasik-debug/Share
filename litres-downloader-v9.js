/**
 * LitRes Downloader v9.0
 * toc.js — основная ссылка на книгу
 * (c) 2026 Diminssoft
 */

(function fullDownloaderV9() {
    console.log('🚀 LitRes Downloader v9.0 — toc.js как основная книга');
        ...
        ">
            ...
            ">
                ...
                <div style="font-size: 11px; color: #6a8aaa; margin-top: 8px;">
                    💡 Нажмите на ссылку, чтобы скачать ZIP-файл с книгой
                </div>
            </div>
    ...
    async function startDownload() {
        ...
        // Если есть прямая ссылка — показываем её и спрашиваем
        if (state.directLink) {
    ...
    console.log(`✅ LitRes Downloader v9.0 загружен!`);
