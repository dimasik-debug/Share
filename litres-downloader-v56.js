/**
 * LitRes Downloader v56.0 — COVER + ABOUT + REVIEWS
 ...
 * 🔄 AUTO-RETRY: 6 попыток + Range-докачка при обрыве ✅ v55
 * 🖼️ COVER + ABOUT.HTML + REVIEWS в каждый ZIP ✅ NEW v56
...
(function fullDownloaderV56() {
    console.log('%c🚀 LitRes Downloader v56.0', 'color:#4a8af4;font-size:16px;font-weight:bold;');
    ...
    ['litres-downloader.js','litres-downloader-v29.js','litres-downloader-v30.js','litres-downloader-v31.js',
     ...
     'litres-downloader-v53.js','litres-downloader-v54.js','litres-downloader-v55.js'
...
<div class="footer">📚 LitRes Downloader v56.0<br>Скачано: ${new Date().toLocaleString('ru-RU')}</div>
</body></html>`;
    }
        ...
        <div id="litres_downloader_ui">
            <div class="ldl-header">
                ...
                <div style="flex:1;min-width:0;">
                    ...
                    <div class="ldl-subtitle">v56.0 · cover + about + reviews</div>
                </div>
    ...
    async function init(){
        ...
        updateButtons();
        updateTabTitle();
        console.log('%c✅ LitRes Downloader v56.0 готов!', 'color:#4ade80;font-weight:bold;font-size:14px;');
    }
