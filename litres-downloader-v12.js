/**
 * LitRes Downloader v12.0
 * Автоопределение JPG/GIF + Укажи сколько страниц скачать
 * (c) 2026 Diminssoft
 */

(function fullDownloaderV12() {
    console.log('🚀 LitRes Downloader v12.0 — Автоопределение формата!');
    ...
    // ============================================================
    // 12. АВТООПРЕДЕЛЕНИЕ ФОРМАТА (JPG/GIF)
    // ============================================================
    async function getImageUrl(pageNum) {
        const apiPage = pageNum - 1;
        
        // Пробуем сначала gif (основной формат)
    ...
    async function startDownload() {
        ...
        // ============================================================
        // НОВОЕ: С какой страницы начать и СКОЛЬКО страниц скачать
        // ============================================================
    ...
    console.log(`✅ LitRes Downloader v12.0 загружен!`);
