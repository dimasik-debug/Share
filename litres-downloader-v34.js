/**
 * LitRes Downloader v34.0
 * 🧹 Автоочистка кэша jsDelivr
 * 🎯 ОДНА КНОПКА СТАРТ — всё автоматически
 * 📦 ZIP → FB2→HTML / PDF / прямое скачивание
 * 📖 JSON fallback (если ZIP нет)
 * 📚 PDF + FB2 + EPUB + HTML
 * (c) 2026 Diminssoft
 */

(function fullDownloaderV34() {
    console.log('🚀 LitRes Downloader v34.0');
    ...
    (function autoPurge() {
        try {
            ...
            ['litres-downloader.js','litres-downloader-v29.js','litres-downloader-v30.js',
             ...
             'litres-downloader-v34.js'].forEach(function(f) {
    ...
    // ============================================================
    // 8. АКТИВАЦИЯ PDF.js (ПОЛНАЯ — с Meta)
    // ============================================================
...
<div class="footer">
    ...
    async function convertAndDownloadHtml() {
        ...
        try {
            ...
            setStatus(`⚠️ ${e.message} → ZIP`, true);
            state.isRunning = false;
            updateButtons();
...
<div class="footer">
        ...
        <div id="litres_downloader_ui" style="position: fixed; bottom: ${px(16)}; right: ${px(16)}; z-index: 99999; background: #ffffff; color: #1a2a4a; border-radius: ${px(14)}; padding: ${px(14)} ${px(16)}; font-family: 'Segoe UI', Arial, sans-serif; font-size: ${px(12)}; width: ${px(390)}; box-shadow: 0 ${px(8)} ${px(32)} rgba(0,0,0,0.15); border: 1px solid rgba(26, 42, 74, 0.08); user-select: none; max-height: 95vh; overflow-y: auto;">
            <div style="display: flex; align-items: center; gap: ${px(8)}; margin-bottom: ${px(10)};">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="font-size: ${px(9)}; color: #8a9aaa; text-transform: uppercase; letter-spacing: 0.3px;">v34.0 • Одна кнопка</div>
                </div>
    ...
    // ============================================================
    // 20. 🎯 ЕДИНАЯ КНОПКА СТАРТ — АВТО-ОПРЕДЕЛЕНИЕ
    // ============================================================
    ...
    async function init() {
        ...
        console.log(`✅ LitRes Downloader v34.0 загружен!`);
        console.log(`🎯 Одна кнопка Старт — авто-определение`);
